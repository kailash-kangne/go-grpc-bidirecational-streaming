...
type GreetServiceClient interface {
	...
	SayHelloBidirecationalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirecationalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBidirecationalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirecationalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBidirecationalStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBidirecationalStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBidirecationalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBidirecationalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBidirecationalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirecationalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBidirecationalStreaming(GreetService_SayHelloBidirecationalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirecationalStreaming(GreetService_SayHelloBidirecationalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirecationalStreaming not implemented")
}
...
func _GreetService_SayHelloBidirecationalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirecationalStreaming(&greetServiceSayHelloBidirecationalStreamingServer{stream})
}

type GreetService_SayHelloBidirecationalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBidirecationalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBidirecationalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirecationalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirecationalStreaming",
			Handler:       _GreetService_SayHelloBidirecationalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
